...
public class WeatherMethodlist {
    ...
    public static String getWeatherUranaiHtml() {
        StringBuilder sb = new StringBuilder();
        sb.append("<section style='margin-top:40px;'>");
        sb.append("<h1 style='text-align:center; color:#cc3366; margin-bottom:20px;'>今日の運勢</h1>");
        sb.append("<ol style='font-size:1.1em;'>");
        int list[][] = new int[3][3];
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                list[i][j] = -1;
        ...
        for (int i = 0; i < 3; i++) {
            ...
            sb.append("<li style='margin-bottom:12px;'>第").append(i + 1).append("位は「").append(constellation[numcon])
                    .append("」<br>")
                    .append("　　ラッキーアイテムは「").append(luckyitem[numitem]).append("」<br>")
                    .append("　　ラッキーカラーは「").append(luckycolor[numcolor]).append("」</li>");
            list[i][0] = numcon;
            list[i][1] = numitem;
            list[i][2] = numcolor;
        }
    ...
    public static final String[] luckyitem = {
    ...
    public static final String[] luckycolor = {
